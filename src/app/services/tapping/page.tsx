        ...
        <div className="container mx-auto px-4 md:px-10 lg:px-20">
          <div className="text-center max-w-3xl mx-auto mb-20 leading-tight">
            ...
            <p className="text-lg text-slate-600 font-medium">
              We provide clean, high-precision internal threads for mechanical assemblies using
              automated tapping heads and rigid setups.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              {
                title: 'Blind & Through Holes',
                desc: 'Advanced depth control allow for both through-hole and blind-hole tapping with chip evacuation.',
                icon: Layers,
          ...
          <div className="flex items-center justify-center pt-10">
            <ExpertCTA description="Looking for specialized thread standards (ACME, Trapezoidal), micro-tapping under M1.6, or tapping in hardened alloys? Our engineering team can help." />
          </div>
        </div>
      </section>
            ...
            <div className="space-y-12">
              <div>
                ...
                <p className="text-xl text-slate-400 leading-relaxed font-medium">
                  Proper pilot hole sizing is the most critical factor for thread strength and tool
                  life.
                </p>
              </div>
              ...
              <div className="space-y-8">
                {[
                  {
                    id: 'T1',
                    title: 'Pilot Hole Sizing',
                    desc: "Ensure your pilot hole matches the 'tap drill' size for the desired thread (e.g. 4.2mm for M5).",
                    icon: <Target className="w-5 h-5" />,
                  },
                  {
                    id: 'T2',
                    title: 'Minimum Material',
                    desc: 'Material thickness should be at least 1.5x the thread pitch to ensure sufficient engagement.',
                    icon: <Zap className="w-5 h-5" />,
                  },
                  {
                    id: 'T3',
                    title: 'Blind Hole Depth',
                    desc: 'Allow for at least 3mm and up to 5mm of extra depth beyond the required thread for chip clearance.',
          ...
          <div className="flex flex-col lg:flex-row gap-20">
            <div className="lg:w-1/3">
              ...
              <p className="text-slate-600 font-medium mb-12">
                Our configurator identifies hole networks and assigns the correct tap tools
                automatically during the design analysis.
              </p>
              ...
              {[
                {
                  ...
                  description:
                    'Upload your CAD. Our system detects cylindrical features and prompts you to select thread standards for each group.',
                },
                {
                  step: '02',
                  title: 'Tagging & Limits',
                  description:
                    'Indicate which holes are tapped. Our engine checks for material hardness and clearance height for the tapping head.',
                },
                {
                  step: '03',
                  title: 'Automated Production',
                  description:
                    'Once confirmed, the design is queued for our automated tapping stations where high-torque leadscrews ensure thread quality.',
                },
              ].map((item, idx) => (
